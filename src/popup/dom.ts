...
export const chkZip = document.getElementById('chk-zip') as HTMLInputElement;
export const zipToggle = document.getElementById('zip-toggle') as HTMLLabelElement;
...
export const fastPaginate = document.getElementById('fast-paginate') as HTMLDivElement;
